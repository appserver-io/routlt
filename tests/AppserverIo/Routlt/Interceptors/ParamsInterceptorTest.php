...
/**
 * AppserverIo\Routlt\Interceptors\ParamsInterceptorTest
 *
 * NOTICE OF LICENSE
 *
...
/**
 * Test implementation for the ParamsInterceptor implementation.
 *
 * @author    Tim Wagner <tw@techdivision.com>
 * @copyright 2015 TechDivision GmbH <info@techdivision.com>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.appserver.io
 */
class ParamsInterceptorTest extends \PHPUnit_Framework_TestCase implements ActionInterface, ValidationAware
{

    /**
     * The interceptor instance to test.
     *
     * @var \AppserverIo\Routlt\Interceptors\ParamsInterceptor
     */
    ...
    {
        $this->interceptor = new ParamsInterceptor();
    }
    ...
    public function testExecute()
    {
        ...
        $mockServletRequest = $this->getMockBuilder('AppserverIo\Appserver\ServletEngine\Http\Request')
            ->setMethods(array('getParameterMap'))
            ->getMock();
